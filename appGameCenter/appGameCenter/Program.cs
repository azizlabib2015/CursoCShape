...
namespace appGameCenter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            diccionarioRanking1.Add(listaPlatform1[2], ranking1);
            diccionarioRanking1.Add(listaPlatform1[1], ranking2);
            diccionarioRanking1.Add(listaPlatform1[0], ranking3);
            Dictionary<Platforms, Ranking> diccionarioRanking2 = new Dictionary<Platforms, Ranking>();
            diccionarioRanking2.Add(listaPlatform2[2], ranking2);

            Game game1 = new Game("Game1", Genres.Action, listaPlatform1, 2015, diccionarioRanking1);
            Game game2 = new Game("Game2", Genres.Puzzles, listaPlatform1, 2010, diccionarioRanking1);
            ...
            //Console.WriteLine(d);
            GameServices.runTest();
           //Console.WriteLine(GameServices.GetScoreCount("Game1", "ranking2"));
